...
_ITEMS = [
    ...
    ("number_of_payees", (8 * "0", 8, "0", lambda x: rjust_zero(x, 8))),
...
_ITEMS += [
    ...
    ("state_income_tax_withheld_total", ("", 18, "\x00", lambda x: rjust_zero(x, 18))),
    ("local_income_tax_withheld_total", ("", 18, "\x00", lambda x: rjust_zero(x, 18))),
